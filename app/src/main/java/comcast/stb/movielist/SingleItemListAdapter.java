...
public class SingleItemListAdapter extends RecyclerView.Adapter<SingleItemListAdapter.SingleItemRowHolder> {
    ...
    private ArrayList<MoviesItem> itemsList;
    private Context mContext;
    private OnItemClickListener mItemClickListener;
    private OnItemSelectListener mItemSelectedListener;

    public SingleItemListAdapter(Context context, ArrayList<MoviesItem> itemsList) {
    ...
    public void onBindViewHolder(SingleItemRowHolder holder, int i) {
        ...
        MoviesItem singleItem = itemsList.get(i);

        holder.itemCardTxtTitle.setText(singleItem.getMovieName());
        Picasso.with(mContext)
                .load(singleItem.getMoviePicture())
                .resize(150,200)
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, int itemPosition, MoviesItem model);
