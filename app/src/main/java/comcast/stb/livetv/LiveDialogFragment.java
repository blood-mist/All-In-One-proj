...
import static comcast.stb.StringData.CHANNEL_ID;
...
public class LiveDialogFragment extends DialogFragment {
    ...
    public static LiveDialogFragment newInstance(String infoHeader, String infoBody, Channel channel, String errorType, boolean canRetry) {
        ...
        bundle.putParcelable(CHANNEL_ID,channel);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            channel =getArguments().getParcelable(CHANNEL_ID);
    ...
    public void onRetryClick() {
        mListener.onRetryBtnInteraction(errorType, channel);
    }
    ...
    public interface OnFragmentInteractionListener {
        void onRetryBtnInteraction(String errorType,Channel channel);
