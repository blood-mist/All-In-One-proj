...
public class LauncherInfoFragment extends DialogFragment {
    ...
    public LauncherInfoFragment() {
        // Required empty public constructor
    }


    public static LauncherInfoFragment newInstance(String infoHeader, String infoBody, int packageId, String packageType, boolean canRetry) {
        LauncherInfoFragment fragment = new LauncherInfoFragment();
    ...
    public void onRetryClick() {
        mListener.onRetryBtnInteraction(packageId, packageType);
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onRetryBtnInteraction(int packageId, String packageType);
    }
}
