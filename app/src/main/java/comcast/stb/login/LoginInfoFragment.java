...
public class LoginInfoFragment extends DialogFragment {
    ...
    public static LoginInfoFragment newInstance(String infoHeader, String infoBody, boolean canRetry) {
    ...
    public void onRetryClick() {
        mListener.onRetryBtnInteraction();
    }
